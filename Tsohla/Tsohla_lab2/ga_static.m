...
%% Повертає статистику пошуку оптимуму для вказаної функції %%
...
F(1) = {@ga_var1};
F(2) = {@ga_var2};
N = 10;      % кількість повторних запусків функції
...
for var = 1:1:2
    ...
    % час виконання, середнє значення, мінімальне значення, похибка %
